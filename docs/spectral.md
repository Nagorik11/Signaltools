...
Identifica los bines (bins) de frecuencia con mayor energía en el espectro.

### `spectral_energy(magnitude)`
Calcula la energía total del espectro (suma de magnitudes al cuadrado).

### `spectral_flatness(magnitude)`
Mide qué tan tonal o similar al ruido es una señal (entropía de Wiener).
